...
<title>Select two columns to plot graph</title>
...
%>
<h3 style="text-align:center">SELECT TWO COLUMNS TO PLOT GRAPH<br></h3>
<div style="margin-left: 550px;margin-top:100px">

<form style="display:inline-block" action="PlotArea.jsp" method="post">
